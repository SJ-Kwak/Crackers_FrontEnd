...
export default function CardPickScreen({ navigation }) {
  const cards = [
    require("../assets/cards/Abocado.png"),
    require("../assets/cards/Ant.png"),
    require("../assets/cards/Bbang.png"),
    require("../assets/cards/Cat.png"),
    require("../assets/cards/Chicken.png"),
    require("../assets/cards/Dish.png"),
    require("../assets/cards/Haedal.png"),
    require("../assets/cards/Ktx.png"),
    require("../assets/cards/Neulbo.png"),
    require("../assets/cards/Star.png"),
  ];
